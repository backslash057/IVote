...
import { X, Copy, Check, QrCode, Share2, MessageCircle, Twitter, Globe, Sparkles } from 'lucide-react';
...
export const ShareModal: React.FC<ShareModalProps> = ({
  ...
  const shareUrl = typeof window !== 'undefined' 
    ? `${window.location.origin}${candidate ? `?candidate=${candidate.id}` : ''}`
    : 'https://ivote.africa/vote/camp-1';
