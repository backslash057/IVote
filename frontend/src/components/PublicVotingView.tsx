...
import { 
  Clock, Search, Share2, ShieldCheck, AlertCircle,
  ExternalLink, Zap
} from 'lucide-react';
                    ...
                    >
                      ...
                      <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                        <div>
                          ...
                          <p className="text-xs text-slate-400 font-medi²um mt-0.5">
                            {candidate.faculty}
                          </p>
      ...
      <section className="mt-8">
          <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 w-full sm:w-auto shrink-0">
              <Link to="/login" className="w-full sm:w-auto rounded-xl bg-emerald-600 px-5 py-2.5 text-center text-xs font-bold text-white shadow-md shadow-emerald-600/30 transition-all hover:bg-emerald-500">
                Espace Organisateur
              </Link>
            </div>
          </div>
