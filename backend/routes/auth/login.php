    ...
    <div class="w-full max-w-md bg-slate-900/90 border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-xl relative z-10">
        <div class="text-center mb-6">
            ...
            <p class="text-xs text-slate-400 mt-1">
                Plateforme de gestion des votes monétisés
            </p>
        </div>
        ...
        <form action="" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="email" required name="email" placeholder="contact@events.cm" class="w-full pl-10 pr-3.5 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500">
                </div>
            </div>
            ...
            <button type="submit" class="w-full py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs shadow-lg shadow-emerald-600/30 transition-all flex items-center justify-center gap-2 mt-2">
        ...
        <div class="w-full flex justify-end gap-2 mt-4 text-xs text-slate-400">
            Nouvel organisateur? 
            <a href="/signup" class="text-emerald-400 hover:underline">Créez un compte</a>
        </div>
    </div>
